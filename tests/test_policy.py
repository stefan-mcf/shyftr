...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Use artifact path /Users/stefan/antaeus/CHASSIS/runtime/dev_manager_pods/worker_runs/x.log as memory.",
...
def test_boundary_policy_checks_metadata_values():
    result = check_source_boundary(
        ...
        metadata={"artifact_path": "/Users/stefan/antaeus/CHASSIS/runtime/file.log"},
    )
