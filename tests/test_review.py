...
def test_approve_and_reject_fragment_append_review_events_without_mutating_fragment(tmp_path):
    ...
    approval = approve_fragment(cell_path, fragment.fragment_id, reviewer="stefan", rationale="durable")
    rejection = reject_fragment(cell_path, fragment.fragment_id, reviewer="stefan", rationale="superseded")
