  ...
  return <main>
    ...
    {tab === "Cells" && <section>
      ...
      <div className="cards">
        ...
        <Card label="Signals" value={counts.signals} /><Card label="Open proposals" value={counts.open_proposals} /><Card label="Hygiene warnings" value={counts.hygiene_warnings} /><Card label="Grid" value={summary?.grid_status || "empty"} />
      </div>
